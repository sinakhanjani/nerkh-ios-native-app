...
// Class LoginView: Responsible for handling specific functionality in the app.class LoginView: UIView {
...
// Variable height:CGFloat: Stores data relevant to this class.        let height:CGFloat = 200.0
...
// Variable animation: Stores data relevant to this class.        let animation = Animation.named("login")
        animationView.animation = animation
        animationView.contentMode = .scaleAspectFit
// Variable endAnimationProgressTime:: Stores data relevant to this class.        let endAnimationProgressTime: AnimationProgressTime = 1
// Variable startAnimationProgressTime:: Stores data relevant to this class.        let startAnimationProgressTime: AnimationProgressTime = 0.4
