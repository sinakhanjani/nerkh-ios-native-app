...
// Class AnimateViewController: Responsible for handling specific functionality in the app.class AnimateViewController: BaseViewController {
    
    public var backgroundView: UIView = {
// Variable view: Stores data relevant to this class.        let view = UIView()
