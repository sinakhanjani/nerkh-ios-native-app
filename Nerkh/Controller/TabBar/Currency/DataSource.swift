...
class CurrencyDataSource: UICollectionViewDiffableDataSource<CurrencyBuilder, Currency> {
    ...
    init(data: [CurrencyBuilder], collectionView: UICollectionView) {
        self.data = data
        filteredItems = []
        let cellProvider = { (_:UICollectionView,_:IndexPath,_:Currency) -> UICollectionViewCell? in
            return nil
        }
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let headerFooter = collectionView.dequeueReusableSupplementaryView(
            ofKind: kind,
